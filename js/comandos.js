...
// function movbola(){
//     if(bola.y + bola.altura >= esquerda.y && bola.y <= esquerda.y + esquerda.altura && bola.x <= esquerda.x + esquerda.altura){
//         bola.dirx = 1;
//         bola.mod += 0.2;
//     }
...
//     // ctx.fillText("Player 2: " + esquerda.score,450,20);
//     ctx.fillText("Player 2: " + esquerda.score,canvas.width -150 ,20);
...
var canvas = document.getElementById("mycanvas");
			...
			function desenha() {
				...
				ctx.fillText("JP Jogos Online: ",230, 20);
